# 3.x Combinational Logic Design
...
!!! note ""
    === "题面"
        ...
        <div style="text-align: center;">
        <img src="/imgs/34.png" style="width: 80%;">
        </div>
    === "答案"
        <div style="text-align: center;">
...
<div style="text-align: center;">
<img src="/imgs/40.png" style="width: 80%;">
</div>
...
???+ note "更复杂的 🌰"
    ...
    <div style="text-align: center;">
    <img src="/imgs/42.png" style="width: 80%;">
    </div>
...
更多的内容可以看 **[MinJoker 的数逻笔记](https://minjoker.github.io/cs/system/digital_logic/note2/#_7){target="_blank"}** 和 **[xxjj 的计组笔记](https://xuan-insr.github.io/computer_organization/3_arithmetic/#311-1-bit-alu){target="_blank"}**（数逻中最多了解到超前进位加法器即可）。
